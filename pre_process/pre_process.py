...
print('The accuracy for Logistic Regression Classifier (tfidf):', accuracy_score(y_test, y_pred1) * 100)
...
y_pred3 = svmModel.predict(X_test_featureExtraction_TFIDF)

print('The accuracy for Support Vector Machines (SVM):', accuracy_score(y_test, y_pred3) * 100)
...
naive_bayes_model_bow = MultinomialNB().fit(X_train_featureExtraction_BagOfword, y_train)
